...
from etas.viz.space import plot_spatial_mc
...
def main():
    ...
    print("Computing spatial Mc grid (MAXC + 0.2)...")
    mc_values = map_spatial_mc(cat_ca, grid_lon, grid_lat, n_events=250)
    
    print("Plotting Mc map...")
    ax = plot_spatial_mc(grid_lon, grid_lat, mc_values)
    
    save_path = "docs/figures/california_mc_map.png"
    Path(save_path).parent.mkdir(parents=True, exist_ok=True)
    
    # plt.subplots created a figure in plot_spatial_mc
    fig = ax.figure
